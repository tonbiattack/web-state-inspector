import type { NetworkBody, NetworkEntry } from '../shared/types.js';

export function networkBodyText(body: NetworkBody): string {
...
export function formatNetworkExchange(entry: NetworkEntry): string {
  return [
