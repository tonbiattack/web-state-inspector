...
function formatNetwork(entry: NetworkEntry, index: number, concise = false): string {
  if (concise) {
...
export function createAiDebugContext(args: {
  ...
  eventContext?: AiDebugContext['eventContext'];
  comparison?: AiDebugContext['comparison'];
}): AiDebugContext {
