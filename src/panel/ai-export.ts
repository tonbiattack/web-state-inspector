import type { AiDebugContext, DebugError, DebugSnapshot, NetworkEntry, SnapshotDiff, StorageChangeEvent, TimelineEvent } from '../shared/types.js';
...
function truncate(value: string, length = 4000): string {
